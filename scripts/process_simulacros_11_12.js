...
qs = qs.filter(q => !(q.origen === 'Historico' && (q.tema.includes('Simulacro 11') || q.tema.includes('Simulacro 12'))));
...
const sim11 = parseFile('c:/Users/34678/Desktop/web-test-pinche/scripts/raw_simulacro_11.txt', 'historico_sim11_ext2017', 'Otras Comunidades: Simulacro 11 - Pinche Extremadura (2017 + 2014)');
const sim12 = parseFile('c:/Users/34678/Desktop/web-test-pinche/scripts/raw_simulacro_12.txt', 'historico_sim12_ext2014', 'Otras Comunidades: Simulacro 12 - Pinche Extremadura (2014)');

qs = qs.concat(sim11, sim12);
